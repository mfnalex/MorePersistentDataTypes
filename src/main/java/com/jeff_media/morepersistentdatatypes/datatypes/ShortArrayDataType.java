...
public class ShortArrayDataType implements PersistentDataType<byte[], short[]> {
    ...
    @Override
    public @NonNull Class<short[]> getComplexType() {
        return short[].class;
    }

    @Override
    @SneakyThrows
    public byte @NonNull [] toPrimitive(final short[] shorts, @NonNull final PersistentDataAdapterContext itemTagAdapterContext) {
    ...
    @Override
    @SneakyThrows
    public short @NonNull [] fromPrimitive(final byte @NonNull [] bytes, @NonNull final PersistentDataAdapterContext itemTagAdapterContext) {
