...
class ConfigurationSerializableDataType <T extends ConfigurationSerializable> implements PersistentDataType<byte[], T> {
    private final Class<T> type;

    ConfigurationSerializableDataType(Class<T> type) {
        this.type = type;
    }
